    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('inventory', 'Inventory Manager'), ('shipping', 'Shipping Manager'), ('owner', 'Owner'), ('customer_service', 'Customer Service'), ('it_support', 'IT Support')], default='inventory', max_length=20)),
